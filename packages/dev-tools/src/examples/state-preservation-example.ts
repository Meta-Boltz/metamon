...
export async function basicHotReloadExample() {
  ...
  pubSubSystem.subscribe('user-updated', (user: any) => {
    console.log('User updated:', user);
  }, 'header-component');
  
  pubSubSystem.subscribe('theme-changed', (theme: any) => {
...
export async function crossFrameworkExample() {
  ...
  pubSubSystem.subscribe('counter-increment', (value: any) => {
  ...
  pubSubSystem.subscribe('data-fetch-complete', (items: any) => {
...
export async function serializationExample() {
  ...
  pubSubSystem.subscribe('complex-event', (data: any) => console.log(data), 'complex-component');
