...
export class BundleAnalyzer {
     ...
     */
    async analyzeSingleBundle(bundle) {
     ...
     */
    async analyzeSizeBreakdown(content, bundle) {
     ...
     */
    async analyzeCompression(bundlePath) {
     ...
     */
    generateBundleSuggestions(bundle, sizeBreakdown, compression) {
        const suggestions = [];
     ...
     */
    generateBundleWarnings(bundle, sizeBreakdown) {
        const warnings = [];
     ...
     */
    async analyzeCrossBundlePatterns(bundles) {
     ...
     */
    generateRecommendations(analyses, crossBundle) {
