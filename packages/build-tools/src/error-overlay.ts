/**
 * Error Overlay Component for Hot Reload Errors
 * 
 * This component creates a browser-side error overlay that displays
 * compilation and reload errors in a user-friendly format.
 */

import type { ReloadError, ErrorDisplayOptions } from './types/error-handling.js';
...
export class ErrorOverlay {
  ...
  /**
   * Show error overlay with the given error
   */
  showError(error: ReloadError): void {
    ...
    if (this.options.autoHide && error.recoverable) {
   ...
   */
  private createOverlay(error: ReloadError): void {
      ...
      <div class="mtm-error-backdrop">
        <div class="mtm-error-container">
          ...
          <div class="mtm-error-content">
            ...
            ${error.suggestion && this.options.showSuggestions ? `
            ...
            ${error.stack && this.options.showStackTrace ? `
  ...
  /**
   * Schedule auto-hide for recoverable errors
   */
